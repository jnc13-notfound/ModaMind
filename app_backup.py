...
def chat_with_agent(
    ...
    if pipeline_state is None:
        ...
        chat_history.append(
            {
                "role": "assistant",
                "content": "Please run the full pipeline first (Generate Report tab), then return here to chat."
            }
        )
        return chat_history, ""
    ...
    try:
        ...
        if "429" in str(e):
            response_text = (
                "This model's quota is exhausted.\n"
    ...
    print("===================================")
    print("CHAT HISTORY TYPE:", type(chat_history))
